...
class User extends React.Component{
    ...
    fileUploadHandler(){
        ...
        if (this.state.selectedFile !== null){
            ...
            fetch('http://localhost:5000/api/user/'+ this.state.user._id +'/picture/', {
                credentials: 'include',
                method: 'PATCH',
                body: fd
            }).then(function(response){
                that.handleUpload();
                console.log("after fetch 1",that.state.upload);
                ...
                .then(function(data) {
                    ...
                    console.log(items);
                    that.handleUpload();
                    console.log("after fetch 2",that.state.upload);
                })
    ...
    render(){
        ...
        return(
            <div>
                <header>
                    <div className="welcome_msg">Welcome, {this.state.userName}</div>
                    <div className="coin">
            ...
            <div className="row" style={{marginTop:"15px"}}>
                <div className="col span-1-of-3 user_photo">
                    ...
                    <div className={showUploadbtn2}>
                        <input className="upload_img" type="file" onChange={this.fileSelectHandler} />
