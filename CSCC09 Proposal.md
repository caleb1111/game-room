...
- WebRTC to connect multiple people together and create a session 
- Angular
- jQuery
...
- Some sort of simplistic game engine to create the battleship game such as melonJS (maybe)

**Top 5 Challenges**

1. Using WebRTC to create peer to peer connections to allow users to play games together in real time while watching pieces of the board interact with each user’s move. WebRTC will be challenging to learn and implement.
2. Learning Angular and able to use it to implement a fully functioned web-app in six week will be quite challenging
3. Styled components will be another challenge when designing the UI 
